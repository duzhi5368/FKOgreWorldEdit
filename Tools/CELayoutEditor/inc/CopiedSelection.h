...
public:
     ...
     */
    void AddRecursiveCopy (const CEGUI::Window* const pWindow);

    /** Pastes the deep copy onto the given Window, which may not be NULL.
     *
     * @param aTarget the Window to paste onto.
     */
    void PasteSelection (CEGUI::Window* aTarget);
...
private:
    ...
    void AddCopyInt( DeepCopy* pData, const CEGUI::Window* const pWindow ) const;
    void AddRecursiveCopyInt( DeepCopy* pData, const CEGUI::Window* const pWindow );
    CEGUI::Window* PasteWindowInt( const DeepCopy& data, CEGUI::Window* pTarget );
    void PasteWindowRecursiveInt( const DeepCopy& data, CEGUI::Window* pTarget );
