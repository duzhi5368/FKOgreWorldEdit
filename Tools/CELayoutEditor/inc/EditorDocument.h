...
public:
    ...
    */
    ...
    void HandleMousePressed (const int aMouseX, const int aMouseY, const bool shiftPressed) ;
    ...
    void SelectWindow (CEGUI::Window* aWindow, const bool resetSelection = true) ;
...
private:
    ...
    * actions (true).*/
    ...
    CEGUI::Window* AddNewWindow (CEGUI::Window* aParentWindow, const CEGUI::String& aType, const CEGUI::String& aName);
