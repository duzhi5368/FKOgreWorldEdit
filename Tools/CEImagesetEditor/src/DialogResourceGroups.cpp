...
void DialogResourceGroups::CreateControls()
{
    ...
    wxStaticBox* itemStaticBoxSizer3Static = new wxStaticBox( itemDialog1, wxID_ANY, wxT( "定义组" ) );
    ...
    m_groupsGrid->SetColLabelValue( 0, wxT( "名称" ) );
    m_groupsGrid->SetColLabelValue( 1, wxT( "目录" ) );
    m_groupsGrid->SetColSize( 0, 100 );
    m_groupsGrid->SetColSize( 1, 320 );
    itemStaticBoxSizer3->Add( m_groupsGrid, 1, wxGROW | wxALL, 5 );

    wxStaticText* itemStaticText5 = new wxStaticText( itemDialog1, wxID_STATIC, wxT( "默认资源组:" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_addGroupButton = new wxButton( itemDialog1, ID_ADDGROUP_BUTTON, wxT( "添加组" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_removeGroupButton = new wxButton( itemDialog1, ID_REMOVEGROUP_BUTTON, wxT( "删除组" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_setDefaultButton = new wxButton( itemDialog1, ID_DEFAULTGROUP_BUTTON, wxT( "设置默认组" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_okButton = new wxButton( itemDialog1, wxID_OK, wxT( "确定(&O)" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_cancelButton = new wxButton( itemDialog1, wxID_CANCEL, wxT( "取消(&C)" ), wxDefaultPosition, wxDefaultSize, 0 );
