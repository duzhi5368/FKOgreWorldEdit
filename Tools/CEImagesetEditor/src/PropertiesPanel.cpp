...
void PropertiesPanel::createContent()
{
    ...
    wxStaticText* lblProps = new wxStaticText( this, ID_TEXT, wxT( "属性" ), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
    ...
    wxStaticText* lblImagesetName = new wxStaticText( this, ID_TEXT, wxT( "Imageset 名称 :" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    // START ----------------------------------------------------------------------------
    // image file selector
    wxStaticText* lblImageFile = new wxStaticText( this, ID_TEXT, wxT( "图片文件 :" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* lblNativeResolution = new wxStaticText( this, ID_TEXT, wxT( "分辨率 :" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_autoScaleCheckbox = new wxCheckBox( this, ID_AUTOSCALE_CHECKBOX, wxT( "自动缩放" ), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* lblImageSet = new wxStaticText( this, ID_TEXT, wxT( "图片定义" ), wxDefaultPosition, wxSize( 250, -1 ), wxALIGN_CENTRE );
...
void PropertiesPanel::createPropertiesGrid( wxWindow* parent )
{
    ...
    //hack, a enlever
    m_propertiesGrid->SetColLabelValue( 0, wxT( "名称" ) );
    ...
    m_propertiesGrid->SetColLabelValue( 3, wxT( "宽" ) );
    m_propertiesGrid->SetColSize( 3, 30 );

    m_propertiesGrid->SetColLabelValue( 4, wxT( "高" ) );
